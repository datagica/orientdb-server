...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="2.2.x@r483093384e4fdbe825e2de0950f007776ee27a84; 2016-12-22 14:57:07+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.2.14.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
