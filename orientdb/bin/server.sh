...
exec "$JAVA" $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS $MAXDISKCACHE \
    ...
    -Dorientdb.build.number="develop@re6e0017eee1660146bbb27715832b82a268a438a; 2016-06-13 15:26:13+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.2.2.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
